        ...
        <>
                                    ...
                                    <div className='ml-auto d-flex align-items-center'>
                                        ...
                                        <ul className='list list-inline mb-0 headerTabs pl-0 mr-4'>
                                            ...
                                            <li className='list-inline-item'>
                                                <span>
                                                    <Link to={'/cart'}> <img alt='' src={IconCart} />
...

            {
                ...
                <ul className='dropdownMenu dropdownMenuAcc' onClick={closeNav}>
                    ...
                    <li><Button className='align-items-center'><Link to=""> <img alt='' src={IconCompare} />Compare</Link></Button></li>
                    <li><Button className='align-items-center'><Link to=""> <img alt='' src={IconCart} />Cart</Link></Button></li>
