                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> ayushd@013</p>
                            ...
                            <div className='col-md-3 part3'>
                                ...
                                <div className='d-flex'>
                                    <Link to={''}><img src={appStore} alt='' width={150} /></Link>
                                    <Link to={''}><img src={googlePlay}alt='' className='mx-2' width={150} /></Link>
                                </div>
                        ...
                        <div className='row lastStrip'>
                            <div className='col-md-3 part_1'>
                                <p>Copyright 2024 © E-commerce-food-application</p>
                            </div>
