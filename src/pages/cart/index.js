...
const Cart = () => {
    ...
    const [cartItems, setCartItems] = useState(context.cartItems);
    ...
    useEffect(() => {
        ...
        window.scrollTo(0, 0);
    }, [context.cartItems, context.isLogin, navigate]);
    ...
    const calculateTotal = () => {
        return cartItems.reduce((total, item) => total + parseInt(item.price.split(",").join("")) * item.quantity, 0);
    };
                                                            ...
                                                            <div className='d-flex align-items-center'>
                                                                <div className='img'>
                                                                    <Link to={`/product/${item.id}`}>
                                                                        <img src={item.catImg + '?im=Resize=(100,100)'} className='w-100' alt={item.productName} />
                                                                    </Link>
                                                                </div>
                            ...
                            <div className='card p-4'>
                                ...
                                <Link to={'/checkout'}>
                                    <Button
                                        ...
                                        onClick={() => context.setCartTotalAmount(calculateTotal())}
                                    >
                                        Proceed To CheckOut
                                    </Button>
                                </Link>
